  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        destructive: "border-transparent bg-destructive/90 text-destructive-foreground hover:bg-destructive/70 backdrop-blur-sm",
        outline: "text-foreground border-white/30 dark:border-white/10 backdrop-blur-sm",
      },
    },
    defaultVariants: {
      variant: "default",
